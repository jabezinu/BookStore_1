...
//       .catch((err) => {
//         console.log(err)
//         alert("Somthing went wrong while creating the book Check your console")
//         setLoading(false)
//       })
//   }
//   return (
...
//           <button onClick={handleCreateButton} >Create Book</button>
//         </div>
//       )}
//     </div>
//   )
...
const Create = () => {
    ...
    const handleCreateButton = () => {
        ...
        axios
            ...
            .catch((err) => {
                console.log(err);
                alert("Something went wrong while creating the book. Check your console");
                setLoading(false);
            });
    };
            ...
            <div className="relative z-10 p-4 md:p-8">
                ...
                <div className="max-w-2xl mx-auto">
                    <div className="relative bg-gradient-to-br from-white/15 to-white/5 backdrop-blur-3xl rounded-[2rem] border border-white/30 shadow-2xl overflow-hidden">
                        ...
                        {/* Enhanced header */}
                        <div className="relative bg-gradient-to-r from-indigo-600/40 via-purple-600/40 to-pink-600/40 backdrop-blur-2xl p-8 border-b border-white/20">
                            <div className="text-center relative">
                                ...
                                <h1 className="text-4xl md:text-5xl font-black text-transparent bg-clip-text bg-gradient-to-r from-cyan-300 via-purple-300 to-pink-300 mb-4 tracking-tight leading-tight">
                                    ADD A BOOK
                                </h1>
                                ...
                                <p className="text-white/90 text-lg md:text-xl font-light">Create a new literary masterpiece</p>
                                ...
                                <div className="space-y-8">
                                    ...
                                    <div className="group relative">
                                        ...
                                        <div className="">
                                            <input
                                                ...
                                                className="w-full bg-gradient-to-r from-white/10 to-white/5 backdrop-blur-2xl border-2 border-white/30 rounded-3xl px-8 py-4 text-black text-lg placeholder-white/60 focus:outline-none focus:border-cyan-400/80 focus:from-white/20 focus:to-white/10 transition-all duration-500 hover:from-white/15 hover:to-white/8 focus:scale-105 focus:shadow-2xl focus:shadow-cyan-400/25"
                                    ...
                                    <div className="group relative">
                                        ...
                                        <div className="relative">
                                            <input
                                                ...
                                                onBlur={() => setFocusedField(null)}
                                                className="w-full bg-gradient-to-r from-white/10 to-white/5 backdrop-blur-2xl border-2 border-white/30 rounded-3xl px-8 py-4 text-black text-lg placeholder-white/60 focus:outline-none focus:border-purple-400/80 focus:from-white/20 focus:to-white/10 transition-all duration-500 hover:from-white/15 hover:to-white/8 focus:scale-105 focus:shadow-2xl focus:shadow-purple-400/25"
                                    ...
                                    <div className="group relative">
                                        ...
                                        <div className="relative">
                                            <input
                                                ...
                                                onBlur={() => setFocusedField(null)}
                                                className="w-full bg-gradient-to-r from-white/10 to-white/5 backdrop-blur-2xl border-2 border-white/30 rounded-3xl px-8 py-4 text-black text-lg placeholder-white/60 focus:outline-none focus:border-pink-400/80 focus:from-white/20 focus:to-white/10 transition-all duration-500 hover:from-white/15 hover:to-white/8 focus:scale-105 focus:shadow-2xl focus:shadow-pink-400/25"
                                    ...
                                    <div className="pt-8">
                                        <button
                                            ...
                                            disabled={loading}
                                            className="group relative w-full bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 hover:from-indigo-500 hover:via-purple-500 hover:to-pink-500 disabled:from-gray-600 disabled:to-gray-700 text-white font-black py-6 px-12 rounded-3xl transition-all duration-500 hover:scale-105 hover:shadow-2xl hover:shadow-purple-500/50 disabled:cursor-not-allowed disabled:hover:scale-100 disabled:hover:rotate-0 overflow-hidden"
                                        >
                                            ...
                                            <div className="relative flex items-center justify-center space-x-4">
                                                ...
                                                <span className="text-2xl tracking-widest font-black">
                                                    {loading ? 'CREATING...' : 'CREATE MASTERPIECE'}
                                                </span>
                    ...
                    {/* Enhanced tip card */}
                    <div className="mt-8 relative bg-gradient-to-r from-yellow-500/20 via-orange-500/20 to-red-500/20 backdrop-blur-2xl rounded-3xl border border-yellow-400/30 p-8 overflow-hidden">
                        ...
                        <div className="relative flex items-center space-x-6">
                            ...
                            <div>
                                ...
                                <p className="text-white/90 text-lg font-light">
                                    Every great story starts with a spark - make it shine! 🌟
                                </p>
                            </div>
                        </div>
                    </div>
